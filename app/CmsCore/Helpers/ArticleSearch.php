 ...
 * @return mixed
 */
function articleSearchHelper($article_type = null, $lang_code = null, $can_be_showed = true)
{
 ...
 * @return mixed
 */
function articleHelper($article_type = null, $lang_code = null, $can_be_showed = true)
{
    return \App\CmsCore\Models\Article::setArticleInfo($article_type, $lang_code, $can_be_showed);
}
